...
package
{
	...
	public class g1266_v29_65640 extends NP9_DocumentExtension
	{
		...
		private function setupVars():void
		{
			...
			bOffline = true;
			//offline version
			mBIOS.debug = true;									//Change this to True or False
			mBIOS.translation = true; 								//Do Not Change
			mBIOS.trans_debug =  false; 							//Do Not Change
			mBIOS.dictionary = false;								//Do Not Change
			mBIOS.game_id =  1266; 								//This Number will be provided by Neopets, For Demo its 13000
			mBIOS.game_lang = "en"; 								//Do Not Change
			mBIOS.meterX = 100;									//This will be the location of the Score Reporting Window From Neopets
			mBIOS.meterY = 200;   									//This will be the location of the Score Reporting Window From Neopets
			mBIOS.script_server = "dev.neopets.com";				//Do Not Change
			mBIOS.game_server = "images50.neopets.com"; 			//Do Not Change
			mBIOS.metervisible = true; 							//Do Not Change
			mBIOS.localTesting = true;								//Will always be true for local Testing for Vendors
			mBIOS.localPathway =  "games/g"+mBIOS.game_id+"/";	//All supplemental Assets must be in a folder with a path name in this format "games/g1212/artwork.swf"
			mBIOS.game_datestamp =  "10/18/10";					//for testing only
			mBIOS.game_timestamp = "11:31AM";						//for testing only
			mBIOS.game_infostamp = "Shenkuu Warrior 2";        //for testing only
			mBIOS.iBIOSWidth = 500;								//Width of the Game
			mBIOS.iBIOSHeight = 600;								//Height of the Game
			mBIOS.width = mBIOS.iBIOSWidth;
			mBIOS.useConfigFile = GAME_USECONFIGFILE;                               //Do Not Change unless Game uses a config.xml File
			mBIOS.configFileVersion = GAME_CONFIGFILEVERSION;						//Do Not Change unless Game doesn't use a config.xml File
			bOffline = true;
