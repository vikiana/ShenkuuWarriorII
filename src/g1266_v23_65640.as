...
package
{
	...
	public class g1266_v23_65640 extends NP9_DocumentExtension
	{
		//--------------------------------------------------------------------------
		// Costants
		//--------------------------------------------------------------------------	
		...
		public const GAME_CONFIGFILEVERSION:int = 4;
		 ...
		 * 
		 */
		public function g1266_v23_65640()
		{
		...
		private function flexHacks():void {
			...
			s.graphics.drawRect(0, 0, 500, 600);
			s.graphics.endFill(); 
			mc.addChild (s);
			addChild (mc);
		...
		private function setupVars():void
		{
			...
			mcBIOS.game_lang = "ch"; 								//Do Not Change
