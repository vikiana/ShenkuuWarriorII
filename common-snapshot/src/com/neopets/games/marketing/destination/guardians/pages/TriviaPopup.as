...
package com.neopets.games.marketing.destination.guardians.pages
{
	...
	import com.neopets.games.marketing.destination.guardians.widgets.QuestionBlock;
	import com.neopets.games.marketing.destination.guardians.widgets.TriviaCallButton;
	...
	public class TriviaPopup extends BroadcasterClip
	{
		...
		//----------------------------------------
		// global variables
		public static var CAMPAIGN_ID:int = 11;
