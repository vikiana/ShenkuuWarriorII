...
package com.neopets.games.marketing.destination.altadorbooths.popsiclebooth.widgets
{
	//----------------------------------------
	//	IMPORTS 
	//---------------------------------------
	...
	import com.neopets.games.marketing.destination.altadorbooths.popsiclebooth.widgets.SimpleRadioButton;
