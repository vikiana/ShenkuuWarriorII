...
package com.neopets.games.marketing.destination.altadorbooths.popsiclebooth.pages
{
	...
	import com.neopets.games.marketing.destination.altadorbooths.common.LogInMessage;
	...
	import com.neopets.games.marketing.destination.altadorbooths.popsiclebooth.widgets.QuestionBlock;
	import com.neopets.games.marketing.destination.altadorbooths.popsiclebooth.widgets.TriviaCallButton;
	...
	public class TriviaPopup extends BroadcasterClip
	{
		...
		//----------------------------------------
		// global variables
		public static var CAMPAIGN_ID:int = 8;
