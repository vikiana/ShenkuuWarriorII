...
package com.neopets.games.marketing.destination.littlestPetShop2010.page
{
	...
	public class VideoPopup extends PageDesitnationBase2 
	{
		 ...
		 */
		 ...
		 override protected function setupPage():void
		 {
			...
			vm.getPlayerInstance(vid).x = 450;
			...
			vm.loadAndPlay(vid, "http://images.neopets.com/sponsors/trailers/lps_parade_high.flv", 320, 240);
