...
package com.neopets.games.marketing.destination.despicableMe
{
	...
	public class DestinationControl extends AbsControl
	{
		...
		//VARIABLES
		//----------------------------------------
		protected var _landingPageURL:String = "landing_page_v1.swf";
		protected var _feedPageURL:String = "feed_page_v1.swf";
		protected var _gamesPageURL:String = "games_page_v1.swf";
		protected var _questPageURL:String = "quest_page_v1.swf";
		protected var _imageGalleryPageURL:String = "imageGallery_page_v1.swf";
		protected var _videoPageURL:String = "trailer_page_v1.swf";
		...
		public function get imageGalleryPageURL():String { return _imageGalleryPageURL; }
		...
		**/
		...
		protected override function setupMainPage():void
		{
			...
			// Dave C. is working on this 5/6  - 
			// check for FlashVar - if Flash Var exists, add PHP FlashVar to URL for separate page
		...
		protected override function setupFeedAPetPage():void
		{
			...
			Parameters.view.loadPage(_feedPageURL); 
		}
		
		// method to create image gallery page
		protected function setupImageGalleryPage():void
		{
			trace ("setup ImageGallery page")
			Parameters.view.loadPage(_imageGalleryPageURL); 
		}
		...
		protected override function setupVideoPage():void
		{
			...
			Parameters.view.loadPage(_videoPageURL); 
		}
