...
package com.neopets.games.marketing.destination.destination_test
{
	...
	public class DestinationView extends AbsView
	{
		...
		//private var mAssetPath:String = "sponsors/testdestination/artAssets/" //temp directory // LIVE
		private var mAssetPath:String = "sponsors/testdestination/artAssets/"	// final pathway
		private var mOnlineMode:Boolean = false;	//change this before putting live.
