...
package com.neopets.games.marketing.destination.destination_test.page
{
	...
	/**
	 *	@NOTE:	This is a short handed quickie version of trivia system and unique as well 
	 ...
	 *			So this only displays the questions and anwers
	...
	public class TriviaPopup extends PageDestinationBase2 {
		...
		protected var trivia:MovieClip;  //movie clip in the library.  Already has necessary text fields
		...
		public function setQuestions(pQuestion:String, pAnswers:Array):void
		{
			trace("p: "+pQuestion);
			trace("a: "+pAnswers);
			if(pQuestion != null && pAnswers != null)
			{
				trivia.triviaQuestion_txt.text = pQuestion;
			}
			//showAnswerOption(pAnswers);  // NULL when testing
