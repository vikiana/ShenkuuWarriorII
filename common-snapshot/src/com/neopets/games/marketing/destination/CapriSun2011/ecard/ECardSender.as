...
package com.neopets.games.marketing.destination.CapriSun2011.ecard
{
	...
	public class ECardSender extends BroadcasterClip
	{
		...
		//----------------------------------------
		// global variables
		public static var PROJECT_ID:String = SixFlagsConstants.FEED_CODE;
		// loacal variables
		...
		public function set (btn:InteractiveObject) {
			// clear listeners
			if(_sendButton != null) {
		...
		*/
		...
		public function onSendRequest(ev:Event) {
			...
			_delegate.callRemoteMethod("SixFlagsService.ActivityService",responder,SixFlagsConstants.ACTIVITY_LINK_ECARD);
			//
			//TrackingProxy.sendADLinkCall('SixFlags2010 - Ecard Sent');
		}
