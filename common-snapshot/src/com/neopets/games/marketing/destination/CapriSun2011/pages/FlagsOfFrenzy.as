...
package com.neopets.games.marketing.destination.CapriSun2011.pages
{
	...
	//import com.neopets.games.marketing.destination.CapriSun2011.text.TextCapriSun2011;
	...
	public class FlagsOfFrenzy extends AbsPageWithBtnState
	{
		...
		//public var messagePopUp:CapriSun2011Popup;
		...
		protected function setupItems():void
		{
			...
			//messagePopUp.addEventListener(CapriSun2011Popup.CLOSE_BTN_EVENT, closeMessageWindow, false, 0, true);
			//messagePopUp.addEventListener(CapriSun2011Popup.LOGIN_BTN_EVENT, onLoginRequest, false, 0, true);
		...
		*/
		...
		protected function sixFlagsStartReturn (msg:Object):void
		{
			...
			switch (result)
			{
				case 0: //Game Played for the day
					//launchMessageBox(TextCapriSun2011.FLAGS_FRENZY_ALREADY_PLAYED);
		...
		protected function amfPHPreturnScorePrize(pFlag:Boolean, pArray = null):void
		{
			...
			{
				//messagePopUp.textField.htmlText = "Congrats! You've grabbed " + String(MainGameArea.score) + " Neopoints<BR> AND a " + pArray[1] + "<br><a href='http://www.neopets.com/objects.phtml?type=inventory'>"+TextCapriSun2011.FLAGS_FRENZY_CHECKINVENTORY+"</a>";		
			}
		...
		*/
		...
		{
			//messagePopUp.textField.htmlText = TextCapriSun2011.FLAGS_FRENZY_INTRO;  
			//messagePopUp.visible = true;
			//messagePopUp.login_btn.visible = false;
		}
		...
		*/
		...
		protected function startGame(evt:Event):void
		{
			...
			{
				//launchMessageBox(TextCapriSun2011.FLAGS_FRENZY_NOTLOGGEDIN);
