...
package com.neopets.games.marketing.destination.CapriSun2011
{
	...
	public class CapriSun2011DestinationView extends CapriSun2011AbsDestinationView
	{
		//----------------------------------------
		// 	CONSTANTS
		//-----------------------------------------
		...
		**/
		public function CapriSun2011DestinationView():void
		{
			super();
			_statsTracker = new NPStatsTracker (CapriSun2011Constants.EXTTRACKING_PROJECT_ID);
			Parameters.assetPath = CapriSun2011Constants.LIB_PATH_BASE;
		...
		override protected function initialize ():void {
			init (new CapriSun2011DestinationControl(), NEOCONTENT_ID, true, mServers.isOnline)
		}
