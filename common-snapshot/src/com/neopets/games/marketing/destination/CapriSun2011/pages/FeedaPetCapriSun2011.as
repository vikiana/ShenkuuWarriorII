...
package com.neopets.games.marketing.destination.CapriSun2011.pages
{
	...
	import com.neopets.games.marketing.destination.CapriSun2011.button.Button;
	import com.neopets.games.marketing.destination.CapriSun2011.subElements.FeedMessagePopUp;
	import com.neopets.games.marketing.destination.CapriSun2011.subElements.SixFlagsFoodItem;
	...
	public class FeedaPetCapriSun2011 extends AbsPageWithBtnState
	{
		//----------------------------------------
		//	CONSTANTS
		//----------------------------------------
		...
		//	CONSTRUCTOR 
		//----------------------------------------
		public function FeedaPetCapriSun2011(pName:String = null, pView:Object = null):void
		{
			super(pName, pView);
			setupPage();
			// finish loading
		...
		{
			amfphp = new DefaultAMFPHP(CapriSun2011Constants.FEED_CODE);
		...
		protected function onFeedRequest(ev:CustomEvent) {
			...
			//delegate.callRemoteMethod("SixFlagsService.ActivityService",responder,CapriSun2011Constants.ACTIVITY_LINK_FEED);
		...
		private function trackFoodItem (food:String):void {
			...
			switch (food){
				case "popcorn_mc":
					ncid = 15963;
					adcall = 'CapriSun2011 - Feed-a-Pet Popcorn';
					break;
				case "apple_mc":
					ncid = 15964;
					adcall = 'CapriSun2011 - Feed-a-Pet Candy Apple';
					break;
				case "lemonade_mc":
					ncid = 15965;
					adcall = 'CapriSun2011 - Feed-a-Pet Frozen Lemonade';
					break;
			}
