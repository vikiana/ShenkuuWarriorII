...
package com.neopets.games.marketing.destination.CapriSun2011.pages
{
	...
	import com.neopets.games.marketing.destination.CapriSun2011.subElements.SixFlags2010InfoPopup;
	import com.neopets.games.marketing.destination.CapriSun2011.subElements.SixFlags2010InfoSwitchPopUp;
	...
	public class InfoScreen extends AbsPageWithBtnState
	{
		...
		protected override function handleObjClick(e:CustomEvent):void
		{
			if (this.visible == true)
			{
				...
				Parameters.onlineMode ? libPath = Parameters.imageURL+ "/" + CapriSun2011Constants.IMG_PATH_BASE : libPath = CapriSun2011Constants.IMG_PATH_BASE;
				
				switch (e.oData.DATA.parent.name)
				{
					case "californiaBtn": //LA
						switchPopUp.init(libPath + CapriSun2011Constants.SIX_FLAGS_CA_IMG,libPath + CapriSun2011Constants.SIX_FLAGS_CA_SF_IMG,"californiaBtn","californiaBtn2",true);
						switchPopUp.visible = true;
						break;

					case "texasBtn": //ARR
						switchPopUp.init(libPath + CapriSun2011Constants.SIX_FLAGS_TX_IMG,libPath + CapriSun2011Constants.SIX_FLAGS_TX_SA_IMG,"texasBtn","texasBtn2");
						switchPopUp.visible = true;
						break;
					case "illinoisBtn":
						...
						messagePopUp.URL = CapriSun2011Constants.SIX_FLAGS_IL_URL;
						messagePopUp.setUpPicture(libPath + CapriSun2011Constants.SIX_FLAGS_IL_IMG);
						messagePopUp.visible = true;
						messagePopUp.activityID = CapriSun2011Constants.ACTIVITY_LINK_INFO_IL;
						//tracking
					...
					case "missouriBtn":
						...
						messagePopUp.URL = CapriSun2011Constants.SIX_FLAGS_MI_URL;
						messagePopUp.setUpPicture(libPath + CapriSun2011Constants.SIX_FLAGS_MI_IMG);
						messagePopUp.visible = true;
						messagePopUp.activityID = CapriSun2011Constants.ACTIVITY_LINK_INFO_MO;
						//tracking
					...
					case "georgiaBtn":
						...
						messagePopUp.URL = CapriSun2011Constants.SIX_FLAGS_GE_URL;
						messagePopUp.setUpPicture(libPath + CapriSun2011Constants.SIX_FLAGS_GE_IMG);
						messagePopUp.visible = true;
						messagePopUp.activityID = CapriSun2011Constants.ACTIVITY_LINK_INFO_GA;
						//tracking
					...
					case "massachusettsBtn":
						...
						messagePopUp.URL = CapriSun2011Constants.SIX_FLAGS_MA_URL;
						messagePopUp.setUpPicture(libPath + CapriSun2011Constants.SIX_FLAGS_MA_IMG);
						messagePopUp.visible = true;
						messagePopUp.activityID = CapriSun2011Constants.ACTIVITY_LINK_INFO_MA;
						//tracking
					...
					case "newYorkBtn":
						...
						messagePopUp.setUpPicture(libPath + CapriSun2011Constants.SIX_FLAGS_NY_IMG);
						messagePopUp.URL = CapriSun2011Constants.SIX_FLAGS_NY_URL;
						messagePopUp.visible = true;
						messagePopUp.activityID = CapriSun2011Constants.ACTIVITY_LINK_INFO_NY;
						//tracking
					...
					case "newJerseyBtn":
						...
						messagePopUp.setUpPicture(libPath + CapriSun2011Constants.SIX_FLAGS_NJ_IMG);
						messagePopUp.URL = CapriSun2011Constants.SIX_FLAGS_NJ_URL;
						messagePopUp.visible = true;
						messagePopUp.activityID = CapriSun2011Constants.ACTIVITY_LINK_INFO_NJ;
						//tracking
					...
					case "marylandBtn":
						...
						messagePopUp.setUpPicture(libPath + CapriSun2011Constants.SIX_FLAGS_MD_IMG);
						messagePopUp.URL = CapriSun2011Constants.SIX_FLAGS_MD_URL;
						messagePopUp.visible = true;
						messagePopUp.activityID = CapriSun2011Constants.ACTIVITY_LINK_INFO_MD;
						//tracking
		...
		protected function imageButtonClicked(evt:CustomEvent):void
		{
			...
			switch (evt.oData.image)
			{
				case "californiaBtn": //LA
					...
					messagePopUp.URL = CapriSun2011Constants.SIX_FLAGS_CA_URL;
					messagePopUp.setUpPicture(libPath + CapriSun2011Constants.SIX_FLAGS_CA_IMG, true);
					messagePopUp.visible = true;
					messagePopUp.activityID = CapriSun2011Constants.ACTIVITY_LINK_INFO_CA_LA;
					//tracking
				...
				case "californiaBtn2": //SF
					...
					messagePopUp.URL = CapriSun2011Constants.SIX_FLAGS_CA_SF_URL;
					messagePopUp.setUpPicture(libPath + CapriSun2011Constants.SIX_FLAGS_CA_SF_IMG, true);
					messagePopUp.visible = true;
					messagePopUp.activityID = CapriSun2011Constants.ACTIVITY_LINK_INFO_CA_SF;
					//tracking
				...
				case "texasBtn": //ARR
					...
					messagePopUp.URL = CapriSun2011Constants.SIX_FLAGS_TX_URL;
					messagePopUp.setUpPicture(libPath + CapriSun2011Constants.SIX_FLAGS_TX_IMG, true);
					messagePopUp.visible = true;
					messagePopUp.activityID = CapriSun2011Constants.ACTIVITY_LINK_INFO_TX_DALLAS;
					//tracking
				...
				case "texasBtn2": //SAN A
					...
					messagePopUp.URL = CapriSun2011Constants.SIX_FLAGS_TX_SA_URL;
					messagePopUp.setUpPicture(libPath + CapriSun2011Constants.SIX_FLAGS_TX_SA_IMG, true);
					messagePopUp.visible = true;
					messagePopUp.activityID = CapriSun2011Constants.ACTIVITY_LINK_INFO_TX_SANTONIO;
					//tracking
