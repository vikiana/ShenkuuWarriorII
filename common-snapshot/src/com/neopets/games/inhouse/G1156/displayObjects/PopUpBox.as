	...
	public class PopUpBox extends MovieClip 
	{
		...
		protected function launchPopup(evt:CustomEvent):void
		{
			var tTranslationManager:TranslationManager = TranslationManager.instance;
		 	...
		 	//TIME BONUS
		 	tTranslationManager.setTextField(txtTimeMessage, tTransData.IDS_MSG_Result2);
		 	tTranslationManager.setTextField(txtMessage, tTransData.IDS_MSG_LEVEL_BONUS);
		 	tTranslationManager.setTextField(txtBonusMessage, tTransData.IDS_MSG_Result);
