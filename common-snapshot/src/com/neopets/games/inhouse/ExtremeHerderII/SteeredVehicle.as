package com.neopets.games.inhouse.ExtremeHerderII
{
	...
	public class SteeredVehicle extends MovingObject
	{
		...
		public function pursue(target:MovingObject):void
		{
		...
		public function evade(target:MovingObject):void
		{
			var lookAheadTime:Number = position.dist(target.position) / _maxSpeed;
		...
		public function inSight(vehicle:MovingObject):Boolean		
		{
		...
		public function tooClose(vehicle:MovingObject):Boolean
		{
