...
{
	import com.neopets.games.inhouse.ExtremePotatoCounterAS3.ExtremePotatoCounter_Translation;
	...
	public class ExtremePotatoCounter_Document extends NP9_DocumentExtension
	{
		...
		private var mGameEngineDemo:ExtremePotatoCounter_Engine;
		protected var mGameShell_Events:GameShell_Events;
		protected var mTranslationData:ExtremePotatoCounter_Translation;
		...
		public function ExtremePotatoCounter_Document():void{
		...
		**/
		...
		{
			mGameEngineDemo = new ExtremePotatoCounter_Engine();
			...
			mcBIOS.game_id = 226;	 														//This Number will be provided by Neopets, For Demo it's 13000, GameEngineTest is 1105
			...
			mTranslationData = new ExtremePotatoCounter_Translation();
