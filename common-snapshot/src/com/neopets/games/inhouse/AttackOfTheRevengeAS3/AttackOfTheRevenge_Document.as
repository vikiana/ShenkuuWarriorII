...
package com.neopets.games.inhouse.AttackOfTheRevengeAS3
{
	...
	public class AttackOfTheRevenge_Document extends NP9_DocumentExtension
	{
		...
		private var mAttackOfTheRevenge_SetUp:AttackOfTheRevenge_SetUp;
		...
		public function AttackOfTheRevenge_Document():void{
		...
		{
			if (evt.oData.CMD == mAttackOfTheRevenge_SetUp.GAME_ENGINE_CLEANED)
			{
		...
		**/
		...
		protected override function gameEngineUpdate():void
		{
			...
			mAttackOfTheRevenge_SetUp.init(this,mcBIOS.finalPathway, mTranslationData);	
		...
		private function cleanupGameEngineShell(evt:CustomEvent = null):void
		{
			...
			mAttackOfTheRevenge_SetUp = null;
			var tPassedObj:Object = evt.oData;
			this.dispatchEvent(new CustomEvent(tPassedObj,SEND_THROUGH_CMD));	
		}
		...
		{
			mAttackOfTheRevenge_SetUp = new AttackOfTheRevenge_SetUp();
			mAttackOfTheRevenge_SetUp.addEventListener(mAttackOfTheRevenge_SetUp.SEND_THROUGH_CMD,sendThroughEvent,false,0,true);	
			...
			mcBIOS.game_id =  1215; 														//This Number will be provided by Neopets, For Demo it's 13000, GameEngineTest is 1105
			mcBIOS.game_lang = "en"; 														//Do Not Change
			mcBIOS.meterX = 150;															//This will be the location of the Score Reporting Window From Neopets
			mcBIOS.meterY = 10;   															//This will be the location of the Score Reporting Window From Neopets
			...
			mcBIOS.iBIOSWidth = 630;											//Width of the Game
			mcBIOS.iBIOSHeight = 460;											//Height of the Game
			bOffline = true;
