...
package com.neopets.games.inhouse.AttackOfTheRevengeAS3
{
	...
	//CLASS DECLARATION
	public class Attack_InstructionsScreen extends InstructionScreen
	{	
		...
		public function Attack_InstructionsScreen ()
		{
		...
		{
			returnBtn.addEventListener(MouseEvent.ROLL_OVER, btnRO );
