...
package com.neopets.games.inhouse.blackPawkeetSlots
{
	...
	public class BlackPawkeetShell extends NP9_GameDocument
	{
		...
		public function BlackPawkeetShell(pLocalPathwayURL:String = null):void{
		...
		**/
		...
		protected override function gameEngineUpdate():void
		{
			...
			if (bOffline)
			{
				tRealPathway = mcBIOS.localPathway;// mcBIOS.localPathway;	
			}
			else
			{
				tRealPathway = _GAMINGSYSTEM.getImageServer() + mcBIOS.localPathway;	
			}	
			
			
			if (mcBIOS.localTesting)
			{
				objGAME.init(this,tRealPathway);	
			}
			else
			{
				objGAME.init(this,tRealPathway,mGameShell_Events,mConfigXML);			
			}
		...
		private function setupVars():void
		{
			...
			mcBIOS.localPathway =  "games/g1099_Slots/";
