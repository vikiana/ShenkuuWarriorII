...
package com.neopets.games.inhouse.blackPawkeetSlots
{
	...
	public class MainGame extends GameEngine
	{
		...
		/**
		 *	Plays soudns
		 *	@PARAM			sound		Sting 		Name of the sound 
		 *	@PARAM			condition	Boolean		if true, play sound, false don't play the sound
		 *	@PARAM			loop		Boolean		set true for sound loop
		 **/
		 ...
		 *	@PARAM			sound		Sting 		Name of the sound
		 *	@PARAM			pVolume		Number 		set the volume to this number
		 **/
		...
		////
		// sets up the (main) MENU introducntion page
		////
