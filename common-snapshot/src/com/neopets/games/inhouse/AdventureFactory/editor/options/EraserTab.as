...
package com.neopets.games.inhouse.AdventureFactory.editor.options
{
	...
	import com.neopets.games.inhouse.AdventureFactory.editor.grid.tools.EraserTool;
	...
	public class EraserTab extends ImageTab
	{
		...
		public function EraserTab():void{
			super();
		...
		override public function get selectionData():Object {
			return new Array(EraserTool,_imageID);
		}
