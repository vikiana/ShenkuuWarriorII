...
{
	import com.neopets.games.inhouse.AdventureFactory.AdventureFactory_Translation;
	...
	import com.neopets.games.inhouse.AdventureFactory.AdventureFactory_Engine;
	...
	public class AdventureFactory_Document extends NP9_DocumentExtension
	{
		...
		private var mGameEngineDemo:AdventureFactory_Engine;
		protected var mGameShell_Events:GameShell_Events;
		protected var mTranslationData:AdventureFactory_Translation;
		...
		public function AdventureFactory_Document():void{
		...
		**/
		...
		{
			mGameEngineDemo = new AdventureFactory_Engine();
			...
			mcBIOS.game_id =  1208; 														//This Number will be provided by Neopets, For Demo it's 13000, GameEngineTest is 1105
			...
			mTranslationData = new AdventureFactory_Translation();
