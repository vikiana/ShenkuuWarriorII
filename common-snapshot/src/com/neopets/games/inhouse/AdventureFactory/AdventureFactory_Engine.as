...
package  com.neopets.games.inhouse.AdventureFactory
{
	 ...
	 * 
	 * 	@NOTE: AdventureFactory_Engine eventually extends EventDispatcher not a DisplayObject.
	...
	public class AdventureFactory_Engine extends GameEngine
	{
		...
		public function AdventureFactory_Engine():void
		{
			super();
		}
