...
{
	import com.neopets.games.inhouse.HeroHeist.HeroHeist_Translation;
	...
	public class HeroHeist_Document extends NP9_DocumentExtension
	{
		...
		private var mGameEngineDemo:HeroHeist_Engine;
		protected var mGameShell_Events:GameShell_Events;
		protected var mTranslationData:HeroHeist_Translation;
		...
		public function HeroHeist_Document():void{
		...
		**/
		...
		protected override function gameEngineUpdate():void
		{
			...
			// making gaming system globally available using flash 6 global variable name
			gMyNeoStatus._GAMINGSYSTEM = _GAMINGSYSTEM; 
		...
		{
			mGameEngineDemo = new HeroHeist_Engine();
			...
			mcBIOS.game_id =  314; 														//This Number will be provided by Neopets, For Demo it's 13000, GameEngineTest is 1105
			...
			mTranslationData = new HeroHeist_Translation();
