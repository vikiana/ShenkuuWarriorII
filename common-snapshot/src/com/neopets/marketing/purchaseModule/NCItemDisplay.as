...
package com.neopets.marketing.purchaseModule
{
	...
	public class NCItemDisplay extends MovieClip 
	{
		...
		protected var _imageArea:MovieClip;
		...
		public function NCItemDisplay():void{
			...
			imageArea = getChildByName("image_area_mc") as MovieClip;
		}
		...
		public function get imageArea():MovieClip { return _imageArea; }
		
		public function set imageArea(dobj:MovieClip) {
			// store new component
			_imageArea = dobj;
			// set up image loop
			initImageLoop();
		...
		public function loadItem(info:NCItemData):void {
			...
			if(_imageLoop != null) {
				...
				_imageLoop.loadImages(info.imageUrls);
			}
