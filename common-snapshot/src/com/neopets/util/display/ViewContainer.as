...
package com.neopets.util.display
{
	...
	public class ViewContainer extends Sprite 
	{
		 ...
		 */
		public function ViewContainer(pID:String = ""):void
		{
			setupVars();
			mID = pID;
		}
		...
		public function removeUIDisplayObject(pID:String):void
		{
			...
			{
				if (mDisplayObjectList[t].hasOwnProperty("ID"))
				{
		...
		{
			var tLength:uint = mDisplayObjectList.length;
			var tDisplayObj:DisplayObject; //  = new DisplayObject();  Abe discovered that this causes an error 
		...
		public function addUIViewContainer(pMediatorVC:ViewContainer,pOrder:uint,pID:String,pPoint:Point = null,pVisibiltyFlag:Boolean = true):void
		{
