...
package com.neopets.util.general
{
	...
	public class GeneralFunctions
	{
		...
		/**
		 * @Note: This function simply limits a value to a certain range.  In effect, this combines the
		 * @Math.max and Math.min functions.
		 * @param		min		Number 		Minimum returned value
		 * @param		val		Number 		Value to be constrained
		 * @param		max		Number		Maximum returned value
		 */
		 
		public static function constrainValue(min:Number,val:Number,max:Number):Number {
