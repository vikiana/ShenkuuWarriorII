...
package com.neopets.util.sound
 {
	...
	public class SoundManager extends EventDispatcher implements ISoundManager
	{
		...
		private static const mInstance:SoundManager = new SoundManager( SingletonEnforcer);
		...
		*/
		...
		public function loadSound(pSoundName:String,pType:String = "SoundFileIsLoaded",pAmountToBuffer:Number = 0,pLocation:String = null,pPool:String = null, pVolume:Number = 1, pID:String = null, pEmbedObjData:EmbedObjectData = null):void
		{
			try {
				...
				{
					case TYPE_SND_SWC:
						trace ( this + "says: case TYPE_SND_SWC = " + TYPE_SND_SWC );
						trace( this + " says: no functionality for case TYPE_SND_SWC defined. Please revise." );
					break;
					case TYPE_SND_EXTERNAL:
					...
					break;
					case TYPE_EMBEDED: 		// This is used for a EMBEDED SWF FILE NOT A SWC
		...
		**/
		...
		{
			//trace( "soundPlay in " + this + " called" );
			try {
