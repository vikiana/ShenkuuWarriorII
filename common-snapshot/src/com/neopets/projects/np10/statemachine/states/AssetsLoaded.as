...
package com.neopets.projects.np10.statemachine.states
{
	...
	/**
	 * public class LoadAssets implements IGameState
	 * 
	 * <p><u>REVISIONS</u>:<br>
	 ...
	 * </p>
	 */
	public class AssetsLoaded extends AbstractState implements IGameState 
	{
		//--------------------------------------------------------------------------
		// Costants
		//--------------------------------------------------------------------------	
		...
		//--------------------------------------------------------------------------
		/**
		 * Creates a new public class LoadAssets implements IGameState instance.
		 * 
		 * <span class="hide">Any hidden comments go here.</span>
		 *
		 * 
		 */
		public function AssetsLoaded()
		{
		}
