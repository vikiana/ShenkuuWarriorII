...
package com.neopets.projects.np10.statemachine.states
{
	...
	/**
	 * public class SendScore implements IGameState
	 * 
	 * <p><u>REVISIONS</u>:<br>
	 ...
	 * </p>
	 */
	public class ScoreResult extends AbstractState implements IGameState
	{
		//--------------------------------------------------------------------------
		// Costants
		//--------------------------------------------------------------------------	
		...
		//--------------------------------------------------------------------------
		/**
		 * Creates a new public class SendScore implements IGameState instance.
		 * 
