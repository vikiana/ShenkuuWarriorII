...
package com.neopets.projects.np10.statemachine.states
{
	...
	/**
	 * public class SetupGame implements IGameState
	 * 
	 * <p><u>REVISIONS</u>:<br>
	 ...
	 * </p>
	 */
	public class GameSetup extends AbstractState implements IGameState
	{
		//--------------------------------------------------------------------------
		// Costants
		//--------------------------------------------------------------------------	
		...
		//--------------------------------------------------------------------------
		/**
		 * Creates a new public class SetupGame implements IGameState instance.
		 * 
