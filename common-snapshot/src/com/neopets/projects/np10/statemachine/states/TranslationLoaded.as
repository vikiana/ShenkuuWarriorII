...
package com.neopets.projects.np10.statemachine.states
{
	...
	/**
	 * public class LoadTranslation implements IGameState
	 * 
	 * <p><u>REVISIONS</u>:<br>
	 ...
	 * </p>
	 */
	public class TranslationLoaded extends AbstractState implements IGameState
	{
		//--------------------------------------------------------------------------
		// Costants
		//--------------------------------------------------------------------------	
		...
		//--------------------------------------------------------------------------
		/**
		 * Creates a new public class LoadTranslation implements IGameState instance.
		 * 
		 * <span class="hide">Any hidden comments go here.</span>
		 *
		 * 
		 */
		public function TranslationLoaded()
		{
		}
