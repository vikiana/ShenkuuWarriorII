...
package com.neopets.projects.destination.videoPlayerComponent
{
	...
	public class VideoPlayerShell extends Sprite
	{
		...
		public function VideoPlayerShell(pABSROOT:Object = null, pDefName:String = undefined, pURLHigh:String = null, pURLLow:String = null,px:Number = 0, py:Number = 0, pHighClickID:int = 0, pLowClickID:int = 0, pSKIP:Boolean = true, pAutoEnd:Boolean = true):void
		{
			//set up video player
			...
			videoContentSetup(pURLHigh, pURLLow, pHighClickID, pLowClickID)
			addChild(vPlayer)
		}
		 ...
		 * @PARAM		pLowClickID		int				NeoContentID for click url (low quality)	
		 **/
		private function videoContentSetup(pURLHigh:String = undefined, pURLLow:String = undefined, pHighNeoContentID:int = 0, pLowNeoContentID:int = 0  ):void
		{
			///////////////////////////////////////////////////////////////
			...
			vPlayer.PARAMETERS.highTrailer1Width_str = 320;
			vPlayer.PARAMETERS.highTrailer1Height_str = 240;
