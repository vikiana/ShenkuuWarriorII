/**
 *	To use this version, you need FeedAPetMain.as and AbstractPet.as
 *	FeedAPetMain: Only deals with amfphp side of feedapet (retrieving data, feed pet, check for login, etc.)
...
package com.neopets.projects.destination.destinationV3.feedapet {
