...
package com.neopets.projects.destination.destinationV3
{
	...
	public class AbsPage extends Sprite {
		...
		//CONSTRUCTOR
		//----------------------------------------
		public function AbsPage(pName:String = null) 
		{
			...
			if (Parameters.view != null)
			{
				...
				trace ("LISTENER IS ADDED");
			}
			else
			{
				trace ("ERROR: Parameters.view is NULL:", this, this.name, "AbsPage Constructor");
			}
		}		
		...
		{  
			if (Parameters.view.hasEventListener(AbsView.OBJ_CLICKED))
			{
		...
		//if pase should have its own processing override this..
