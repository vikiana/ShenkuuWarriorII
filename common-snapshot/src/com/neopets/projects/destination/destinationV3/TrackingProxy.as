...
package com.neopets.projects.destination.destinationV3
{
	...
	public class TrackingProxy extends Object
	{
		...
		public static function sendADLinkCall(id:String) {
			trace ("Sending AD Link Call (Omniture)"+id);
		...
		public static function sendReportingCall(id:String, prjName:String) {
			if (ExternalInterface.available) {
				try { 
					ExternalInterface.call("sendReportingCall",id, prjName);
