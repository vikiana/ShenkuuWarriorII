...
package com.neopets.projects.destination.destinationV3
{
	...
	public class AbsDatabase extends MovieClip
	{
		//----------------------------------------
		//VARIABLES
		//----------------------------------------
		...
		//CONSTRUCTOR 
		//----------------------------------------
		public function AbsDatabase(pUserName:String = "GUEST_USER_ACCOUNT", pProjectID:String = "TYPE14ITEM0000"):void
		...
		{
			trace (this+" - Calling script: "+pAction);
		...
		private function onComplete_Handler (evt:Event):void
		{
			...
			var myXML:XML = new XML(unescape(evt.target.data))
			trace ("result from DB XML:"+myXML);
			parceXML(myXML)
			trace ("result from DB parsed:"+mDataObj);
