...
package com.neopets.projects.destination
{
	...
	public class AbstractDestinationControl extends EventDispatcher
	{
		//----------------------------------------
		//VARIABLES
		//----------------------------------------
		...
		//CONSTRUCTOR 
		//----------------------------------------
		public function AbstractDestinationControl(pDocumentClass:Object):void
		{
			trace ("destination control initialized")
			mView = pDocumentClass
			mView.addEventListener(AbstractDestinationView.OBJ_CLICKED, handleObjClick);
			mView.addEventListener(AbstractDestinationView.SETUP_READY, handleSetupReady);			
		}
		 ...
		 **/
		protected function sendTrackerID(trackID:uint):void 
		{
		...
		protected function processClickURL(linkID:int):void
		{
