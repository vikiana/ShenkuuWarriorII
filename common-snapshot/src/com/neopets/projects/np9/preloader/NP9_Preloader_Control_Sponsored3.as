// ---------------------------------------------------------------------------------------
// Dynamic Sponsored Game PreLoader - Preloader Clickable
//
// Author: Ollie B.
...
package com.neopets.projects.np9.preloader
{
	...
	// -----------------------------------------------------------------------------------
	public class NP9_Preloader_Control_Sponsored3 extends MovieClip {
		...
		// CONSTRUCTOR
		// -------------------------------------------------------------------------------
		public function NP9_Preloader_Control_Sponsored3() {
		...
		public function initLogoTracking( p_iGameWidth:Number=640,
			...
			if ( !bTrackingCalled ) {
				...
				var logoClickRequest:URLRequest = new URLRequest( sSpClickUrl );
		...
		public function onClicked( e:MouseEvent ):void {
			...
			navigateToURL( new URLRequest( sSpClickUrl ), "_blank" );
		}
