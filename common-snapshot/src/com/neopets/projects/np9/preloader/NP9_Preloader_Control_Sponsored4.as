// ---------------------------------------------------------------------------------------
// Dynamic Sponsored Game PreLoader - Not Clickable
//
// Author: Ollie B.
...
package com.neopets.projects.np9.preloader
{
	...
	// -----------------------------------------------------------------------------------
	public class NP9_Preloader_Control_Sponsored4 extends MovieClip {
		...
		// CONSTRUCTOR
		// -------------------------------------------------------------------------------
		public function NP9_Preloader_Control_Sponsored4() {
