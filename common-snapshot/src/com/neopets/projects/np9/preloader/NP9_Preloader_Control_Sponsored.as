// ---------------------------------------------------------------------------------------
// Dynamic Sponsored Game PreLoader
//
// Author: Ollie B.
...
package com.neopets.projects.np9.preloader
{
	...
	// -----------------------------------------------------------------------------------
	public class NP9_Preloader_Control_Sponsored extends MovieClip {
		...
		// CONSTRUCTOR
		// -------------------------------------------------------------------------------
		public function NP9_Preloader_Control_Sponsored() {
		...
		// ---------------------------------------------------------------
		public function initLogoTracking( p_iGameWidth:Number,
										  p_iGameHeight:Number,
										  p_sSpLogoURL:String,
										  p_iSpTrackID:Number,
										  p_sSpAdURL:String ):void {
		...
		public function onLogoLoaded( e:Event ):void {
			...
			//mcLogo = MovieClip( e.target.content );
			setLogoSize();
		}
		...
		private function onPreloaderEnterFrame( e:Event ):void {
			...
			if ( !bLogoLoaded ) {
				...
				//mcLogo = mcMain.mcAni.logoLoader.createEmptyMovieClip("logo",10);
